...
class StructHolder(object):
    ...
    def __getstate__(self):
        ...
        for struct_name, struct in self.___structs.items():
            pickled_object.append({
                "__struct__": struct.__struct__,
                "__endian__": struct.__endian__,
                "__has_padding__": struct.__has_padding__,
                "__name__": struct.__name__
            })
    ...
    def __setstate__(self, state):
        self.___structs = {}
        for obj in state:
            self.___structs[obj['__name__']](build_struct(**obj))
